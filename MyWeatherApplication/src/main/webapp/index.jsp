     ...
     <form action="MyServelet" method="post" class="searchInput">
        ...
        <div class="weatherDetails">
            <div class="weatherIcon">
                <img src="https://img.freepik.com/premium-psd/snowflake-snow-clod-weather-3d-icon-illustration_47987-10705.jpg?semt=ais_hybrid" alt="weather-logo.png" id="weather-icon">
                <h2>${temperature} °C</h2>
